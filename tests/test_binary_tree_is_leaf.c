...
void test_root_no_leaf(void)
{
	binary_tree_print(root);
	TEST_ASSERT_FALSE(binary_tree_is_leaf(root));
}

void test_missing_left(void)
{
	binary_tree_delete(root->right->right);
	root->right->right = NULL;
	binary_tree_print(root);
	TEST_ASSERT_FALSE(binary_tree_is_leaf(root->right));
}

void test_missing_right(void)
{
	binary_tree_delete(root->right->left);
...
{
	binary_tree_print(root);
    TEST_ASSERT_TRUE(binary_tree_is_leaf(root->left->left));
    TEST_ASSERT_TRUE(binary_tree_is_leaf(root->left->right));
    TEST_ASSERT_TRUE(binary_tree_is_leaf(root->right->left));
    TEST_ASSERT_TRUE(binary_tree_is_leaf(root->right->right));
}
...
void test_single_node(void)
{
	...
	TEST_ASSERT_NOT_NULL(root);
	binary_tree_print(root);
	TEST_ASSERT_TRUE(binary_tree_is_leaf(root));
}
